...
function SignIn() {
  return (
    <>
      <header className="text-center max-w-[600px] mx-auto 2xl:mb-[78px] mb-10">
        <h1 className="text-xl font-extrabold lg:text-2xl 2xl:text-[38px] 2xl:leading-[97.52px] mb-[13px]">
          Login!
        </h1>
